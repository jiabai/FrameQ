...
| File | Focus |
|------|-------|
| `2026-08-04-retry-insights-progress-aware-watchdog-plan.md` | Extend `RetryInsights` to a 30-minute idle / 90-minute absolute policy and emit validated content-free transcript-dissection call-boundary progress. |
