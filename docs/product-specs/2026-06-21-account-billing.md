...
The current desktop-visible unlock path is email login plus administrator-issued activation codes. The user-facing entitlement is still a monthly pass: redeeming a code opens a 31-day monthly pass and grants the configured insight-generation quota.
...
- Redemption grants a 31-day monthly pass entitlement and the configured insight-generation quota.
