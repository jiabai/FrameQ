...
- 当前桌面诊断信息导出计划：`docs/exec-plans/active/2026-08-09-desktop-diagnostic-export-plan.md`（contract v8 → ASR 下载专用安全日志 → Rust ZIP 导出 → 双入口与三语言 → 自动化门禁已完成；Windows Save As 手测已完成，macOS 原生烟测待目标主机）
