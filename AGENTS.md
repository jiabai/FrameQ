...
- 当前 active 协议加固计划：`docs/exec-plans/active/2026-07-19-closed-worker-terminal-results-plan.md`
- 最近完成执行计划：`docs/exec-plans/completed/2026-07-19-typed-worker-job-facade-plan.md`
