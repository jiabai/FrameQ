...
- RetryInsights 进度感知 watchdog 计划（active）：`docs/exec-plans/active/2026-08-04-retry-insights-progress-aware-watchdog-plan.md`（30 分钟 idle、90 分钟 absolute、解剖调用边界进度）
