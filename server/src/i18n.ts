...
const STRINGS: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "admin.col_prefix": "前缀",
    "admin.col_source": "来源",
    "admin.col_bound_email": "绑定邮箱",
    "admin.col_delivery_status": "投递/状态",
    "admin.col_disabled_reason": "停用原因",
    "admin.col_created_at": "创建时间",
    "admin.col_sent_at": "发送时间",
    "admin.col_status": "状态",
    ...
    "admin.code_source_admin": "管理员发放",
    "admin.code_source_self_service_email": "自助邮件",
    "admin.code_pending_delivery": "待发送",
    "admin.code_active": "可兑换",
    "admin.code_redeemed": "已兑换",
    "admin.code_expired": "已过期",
    "admin.code_disabled": "已停用",
    "admin.code_reason_delivery_failed": "投递失败",
    "admin.code_reason_superseded": "已被替代",
    "admin.code_reason_activation_became_active": "激活后停发",
    "admin.none": "无",
  ...
  "zh-TW": {
    ...
    "admin.col_prefix": "前綴",
    "admin.col_source": "來源",
    "admin.col_bound_email": "綁定電子郵件",
    "admin.col_delivery_status": "投遞/狀態",
    "admin.col_disabled_reason": "停用原因",
    "admin.col_created_at": "建立時間",
    "admin.col_sent_at": "發送時間",
    "admin.col_status": "狀態",
    ...
    "admin.code_source_admin": "管理員發放",
    "admin.code_source_self_service_email": "自助郵件",
    "admin.code_pending_delivery": "待發送",
    "admin.code_active": "可兌換",
    "admin.code_redeemed": "已兌換",
    "admin.code_expired": "已過期",
    "admin.code_disabled": "已停用",
    "admin.code_reason_delivery_failed": "投遞失敗",
    "admin.code_reason_superseded": "已被替代",
    "admin.code_reason_activation_became_active": "啟用後停發",
    "admin.none": "無",
    "admin.entitlement_days_suffix": " 天",
  },
  ...
  en: {
    ...
    "admin.col_bound_email": "Bound email",
    "admin.col_delivery_status": "Delivery / status",
    "admin.col_disabled_reason": "Disabled reason",
    "admin.col_created_at": "Created at",
    "admin.col_sent_at": "Sent at",
    ...
    "admin.code_source_admin": "Admin issued",
    "admin.code_source_self_service_email": "Self-service email",
    "admin.code_pending_delivery": "Pending delivery",
    "admin.code_active": "Available",
    "admin.code_redeemed": "Redeemed",
    "admin.code_expired": "Expired",
    "admin.code_disabled": "Disabled",
    "admin.code_reason_delivery_failed": "Delivery failed",
    "admin.code_reason_superseded": "Superseded",
    "admin.code_reason_activation_became_active": "Activation became active",
    "admin.none": "None",
