  ...
  "zh-CN": {
    dissection: {
      ...
      report: {
        ...
        highlights: "亮点金句", strengths: "亮点", weaknesses: "短板", template: "可复用骨架", audienceFit: "受众适配",
  ...
  "zh-TW": {
    dissection: {
      ...
      report: {
        ...
        highlights: "亮點金句", strengths: "亮點", weaknesses: "短板", template: "可重用骨架", audienceFit: "受眾適配",
        fit: { high: "高", medium: "中", low: "低" },
      },
    },
  },
  "en-US": {
    dissection: {
      ...
      report: {
        ...
        highlights: "Highlights", strengths: "Strengths", weaknesses: "Weaknesses", template: "Reusable template", audienceFit: "Audience fit",
